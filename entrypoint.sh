...
mkdir -p /tmp/kaniko
cd /tmp/kaniko
url="https://github.com/k8stooling/kaniko-standalone/releases/download/v1/kaniko-binaries-linux-${platform}.tar.gz"
curl -L -o /tmp/kaniko-binaries.tar.gz $url
tar zxf /tmp/kaniko-binaries.tar.gz
